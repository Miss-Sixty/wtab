export default {
  ...
  deviceList: [
    { type: 'Desktop', icon: 'i-solar-monitor-bold', width: '100%', num: -1 },
    { type: 'Tablet', icon: 'i-solar-tablet-bold', width: '768px', num: 8 },
    { type: 'Phone', icon: 'i-solar-smartphone-bold', width: '375px', num: 4 },
  ],
